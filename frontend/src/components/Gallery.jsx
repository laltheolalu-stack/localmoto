...
const images = [
  {
    ...
    caption: "Build №014 — on the bench",
    tall: true,
  },
  {
    ...
    caption: "Restored clocks — '72 Bonneville",
  },
  {
  ...
  },
  {
    ...
    caption: "Build №009 — brat, blacked out",
  },
  {
  ...
  },
  {
    ...
    caption: "Build №011 — ready to hand over",
    tall: true,
  },
];
    ...
    <section id="gallery" ref={ref} className="py-28 lg:py-40 border-b border-white/10" data-testid="gallery-section">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16 lg:mb-24">
          <div>
            <p className="mono-label text-[#D35400] mb-5" data-testid="gallery-kicker">Custom work</p>
            <TrackedHeading className="text-5xl md:text-7xl" data-testid="gallery-heading">
              Built by hand.<br />
              <span className="text-stroke">One of one.</span>
            </TrackedHeading>
          </div>
          <p className="text-[#A1A1AA] text-base max-w-md leading-relaxed">
            Deep shadows, bare metal, mechanical detail. A few frames from the
            custom side of the shop — every build numbered, none repeated.
          </p>
        </div>
