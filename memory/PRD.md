...
- 2026-08-14: Owner's real logo added everywhere — processed from the uploaded JPEG to white-artwork-on-transparent for the dark site (original border cleaned out). Placed in: site header, footer giant lockup (replaces outline text), admin login card, admin dashboard header, and as favicon/apple-touch-icon (/logo.png, /favicon.png). Verified visually on all surfaces. Emails do NOT include the logo (needs a permanent hosted URL — revisit after domain is set).
- 2026-08-15: Real Google reviews replace sample testimonials — Mélissa Jérôme (Local Guide, 28 reviews) and Line Gregoire, both 5 stars, shown with star row + "Google review"/"Avis Google" label; French site shows the original French review text. Public email Pierre.localmoto@gmail.com added under the phone number in the contact section (mailto link, translated label). "See all our Google reviews" button under testimonials links to Google Maps search for the business (owner can supply exact listing URL). Address + footer email show ↗ link affordances; contact address has a "Get directions/Itinéraire" hint.
- 2026-08-16: MOT / contrôle technique removed as a service per owner request — services now three (repairs & diagnostics, servicing & maintenance, tyres & fitting) renumbered 01–03; removed from marquee, booking chips (EN+FR), hero subcopy (EN+FR), page meta description. Old bookings with that service_type remain in DB history.
